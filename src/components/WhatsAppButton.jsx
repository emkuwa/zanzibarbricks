...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent(tr(language, 'whatsappDefault'))
  ...
  return (
    <a
      ...
      onClick={() => { if (typeof gtag !== 'undefined') gtag('event', 'click', { event_category: 'WhatsApp', event_label: 'Floating Button' }) }}
      ...
      aria-label="Order bricks via WhatsApp"
    >
